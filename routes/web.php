...
// Route Miscellaneous Pages
    ...
    Route::get('/admin-error-404', 'MiscellaneousController@error_404');
    Route::get('/error-500', 'MiscellaneousController@error_500');
    Route::get('/admin-error-500', 'MiscellaneousController@error_500');
...
// Route Extension Components
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::get('/admin/dashboard-ecommerce', 'AdminController@dashboard');
        Route::match(['GET', 'POST'], '/admin/change-password', 'AdminController@changepassword');
        Route::get('/admin/chk-password', 'AdminController@chkPassword');
    
    
        // Route Categories (admin)
      //  Route::match(['GET', 'POST'], '/admin/add-category', 'CategoryController@addCategory');
        
        //Route for building dynamic Page From DB  should not published on production
        Route::match(['GET', 'POST'], '/admin/creat-form', 'AdminController@creatForm');
        Route::resource('/admin/add-category', 'CategoryController');
