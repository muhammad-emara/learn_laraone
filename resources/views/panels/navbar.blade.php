                            ...
                            <ul class="nav navbar-nav float-right">
                                            ...
                                            <!--   small 62 Days ago--><a class="d-flex justify-content-between"
                                                ...
                                                <div class="media d-flex align-items-start">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <small class="notification-text"> Are your going to meet me
                                                            tonight?
                                                        </small>
                                                    </div>
                                                    <small>
                                                ...
                                                <div class="media d-flex align-items-start">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="danger media-heading yellow darken-3">Warning
                                                            notifixation</h6>
                                                        <small class="notification-text">Server have 99% CPU usage.
                                                        </small>
                                                    </div>
                                                    <small>
                                                ...
                                                <div class="media d-flex align-items-start">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <small class="notification-text">Cake sesame snaps cupcake
                                                        </small>
                                                    </div>
                                                    <small>
                                                        <time class="media-meta" datetime="2015-06-11T18:29:20+08:00">
                                                ...
                                                <div class="media d-flex align-items-start">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <small class="notification-text">Chocolate cake oat cake
                                                            tiramisu marzipan
                                                        </small>
                                                    </div>
                                                    <small>
                                ...
                                <li class="dropdown dropdown-user nav-item"><a
                                        ...
                                        <span><img class="round"
                                                   src="{{asset('images/backend_images/portrait/small/avatar-s-11.png') }}"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item"  href="{{ url('/admin/change-password') }}">
                                            <i   class="feather icon-lock"></i> Change  Passowrd</a>
                                        <a class="dropdown-item"   href="app-email">
                                            <i  class="feather icon-mail"></i> My Inbox</a><a class="dropdown-item"
                                                                                              href="app-todo"><i
