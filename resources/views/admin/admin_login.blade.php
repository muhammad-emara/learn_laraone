...
@section('myscript')
    {{-- <script src="{{ asset(mix('js/backend_js/scripts/auth/login.js')) }}"></script> --}}
@endsection
            ...
            <div class="card bg-authentication rounded-0 mb-0">
                <div class="row m-0">
                    <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                        <img src="{{ asset('images/backend_images/pages/login.png') }}" alt="branding logo">
                    </div>
                                ...
                                @if (Session::has('flash_massage_success'))
                                        <div class="chip chip-warning mr-1">
                                            <div class="chip-body">
                                                ...
                                                <span class="chip-text"> {!!   session('flash_massage_success') !!}</span>
                                            </div>
                                        </div>
                                    ...
                                    <form method="POST" action="{{ url('admin') }}">
                                        ...
                                        <fieldset class="form-label-group form-group position-relative has-icon-left">
                                            ...
                                            <input id="email" type="email"
                                                   ...
                                                   data-validation-required-message="Must be a valid email" name="email"
