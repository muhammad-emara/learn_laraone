...
@section('mystyle')
        {{-- Page Css files --}}
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/pages/faq.css')) }}">
@endsection
@section('content')
              ...
              <div class="card-body">
                  ...
                  <div class="supporter-details mt-2">
                      <div class="supporter-img d-inline-block">
                          <img class="rounded-circle" src="{{ asset('images/backend_images/portrait/small/avatar-s-1.png') }}" alt="Avatar">
                      </div>
                  ...
                  <div class="supporter-details mt-2">
                      <div class="supporter-img d-inline-block">
                          <img class="rounded-circle" src="{{ asset('images/backend_images/portrait/small/avatar-s-2.png') }}" alt="Avatar">
                      </div>
                      <div class="supporter-info d-inline-block">
                  ...
                  <div class="supporter-details mt-2">
                      <div class="supporter-img d-inline-block">
                          <img class="rounded-circle" src="{{ asset('images/backend_images/portrait/small/avatar-s-3.png') }}" alt="Avatar">
                      </div>
                      <div class="supporter-info d-inline-block">
                  ...
                  <div class="supporter-details mt-2">
                      <div class="supporter-img d-inline-block">
                          <img class="rounded-circle" src="{{ asset('images/backend_images/portrait/small/avatar-s-4.png') }}" alt="Avatar">
                      </div>
                      <div class="supporter-info d-inline-block">
                  ...
                  <div class="supporter-details mt-2">
                      <div class="supporter-img d-inline-block">
                          <img class="rounded-circle" src="{{ asset('images/backend_images/portrait/small/avatar-s-5.png') }}" alt="Avatar">
                      </div>
                      <div class="supporter-info d-inline-block">
