                  ...
                  <div class="chat">
                    <div class="chat-avatar">
                      <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
                          <img src="{{ asset('images/backend_images/portrait/small/avatar-s-2.png') }}" alt="avatar" height="40" width="40"/>
                      </a>
                    </div>
                    <div class="chat-body">
                  ...
                  <div class="chat chat-left">
                    <div class="chat-avatar mt-50">
                      <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
                        <img src="{{ asset('images/backend_images/portrait/small/avatar-s-5.png') }}" alt="avatar" height="40" width="40"/>
                      </a>
                    </div>
                    <div class="chat-body">
                      <div class="chat-content">
...
@section('myscript')
        {{-- Page js files --}}
        <script src="{{ asset(mix('js/backend_js/scripts/pages/dashboard-ecommerce.js')) }}"></script>
@endsection
