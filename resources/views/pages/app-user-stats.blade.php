...
@section('mystyle')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/pages/app-users.css')) }}">
@endsection
@section('content')
<!-- User Table -->
<section>
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-20.png"
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-1.png"
                    alt="avtar img holder"
                    height="32"
                    width="32"
                  />
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-2.png"
                    alt="avtar img holder"
                    height="32"
                    width="32"
                  />
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-3.png"
                    alt="avtar img holder"
                    height="32"
                    width="32"
                  />
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-4.png"
                    alt="avtar img holder"
                    height="32"
                    width="32"
                  />
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-5.png"
                    alt="avtar img holder"
                    height="32"
                    width="32"
                  />
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-6.png"
                    alt="avtar img holder"
                    height="32"
                    width="32"
                  />
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-7.png"
                    alt="avtar img holder"
                    height="32"
                    width="32"
                  />
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-8.png"
                    alt="avtar img holder"
                    height="32"
                    width="32"
                  />
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-9.png"
                    alt="avtar img holder"
                    height="32"
                    width="32"
                  />
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-10.png"
                    alt="avtar img holder"
                    height="32"
                    width="32"
                  />
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-11.png"
                    alt="avtar img holder"
                    height="32"
                    width="32"
                  />
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-12.png"
                    alt="avtar img holder"
                    height="32"
                    width="32"
                  />
            ...
            <tr>
              ...
              <td>
                <div class="user-info">
                  <img
                    class="round mr-1"
                    src="../../../app-assets/images/backend_images/portrait/small/avatar-s-13.png"
                    alt="avtar img holder"
                    height="32"
                    width="32"
                  />
...
@section('myscript')
        <!-- Page js files -->
        <script src="{{ asset(mix('js/backend_js/scripts/datatables/user-datatable.js')) }}"></script>
@endsection
