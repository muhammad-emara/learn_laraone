...
<div class="chat-profile-sidebar">
        <header class="chat-profile-header">
          ...
          <div class="header-profile-sidebar">
            <div class="avatar">
              <img src="{{ asset('images/backend_images/portrait/small/avatar-s-11.png') }}" alt="user_avatar" height="70" width="70">
      ...
      <div class="sidebar-content card">
          ...
          <div class="chat-fixed-search">
              <div class="d-flex align-items-center">
                <div class="sidebar-profile-toggle position-relative d-inline-flex">
                  <div class="avatar">
                    <img src="{{ asset('images/backend_images/portrait/small/avatar-s-11.png') }}" alt="user_avatar" height="40" width="40">
          ...
          <div id="users-list" class="chat-user-list list-group position-relative">
              ...
              <ul class="chat-users-list-wrapper media-list">
                <li>
                    <div class="pr-1">
                        <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="{{ asset('images/backend_images/portrait/small/avatar-s-3.png') }}" height="42" width="42" alt="Generic placeholder image">
                        <i></i>
                        </span>
                    </div>
                ...
                <li>
                    <div class="pr-1">
                        <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="{{ asset('images/backend_images/portrait/small/avatar-s-7.png') }}" height="42" width="42" alt="Generic placeholder image">
                        <i></i>
                        </span>
                    </div>
                    <div class="user-chat-info">
              ...
              <ul class="chat-users-list-wrapper media-list">
                <li>
                    <div class="pr-1">
                        <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="{{ asset('images/backend_images/portrait/small/avatar-s-8.png') }}" height="42" width="42" alt="Generic placeholder image">
                        <i></i>
                        </span>
                    </div>
                    <div class="user-chat-info">
                ...
                <li>
                    <div class="pr-1">
                        <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="{{ asset('images/backend_images/portrait/small/avatar-s-5.png') }}" height="42" width="42" alt="Generic placeholder image">
                        <i></i>
                        </span>
                    </div>
                    <div class="user-chat-info">
                ...
                <li>
                    <div class="pr-1">
                        <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="{{ asset('images/backend_images/portrait/small/avatar-s-9.png') }}" height="42" width="42" alt="Generic placeholder image">
                        <i></i>
                        </span>
                    </div>
                    <div class="user-chat-info">
                ...
                <li>
                    <div class="pr-1">
                        <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="{{ asset('images/backend_images/portrait/small/avatar-s-14.png') }}" height="42" width="42" alt="Generic placeholder image">
                        <i></i>
                        </span>
                    </div>
                    <div class="user-chat-info">
