...
@section('mystyle')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/plugins/extensions/media-plyr.css')) }}">
@endsection
@section('content')
...
@section('myscript')
        <!-- Page js files -->
        <script src="{{ asset(mix('js/backend_js/scripts/extensions/media-plyr.js')) }}"></script>
@endsection
