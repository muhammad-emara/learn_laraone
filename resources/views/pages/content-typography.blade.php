              ...
              <blockquote class="blockquote pl-1 border-left-primary border-left-3">
                <div class="media">
                  <div class="media-left pr-1">
                    <img class="media-object img-xl" src="{{ asset('images/backend_images/portrait/small/avatar-s-5.png') }}"
                ...
                <div class="media">
                  <div class="media-left pr-1">
                    <img class="media-object img-xl rounded-circle"
                      src="{{ asset('images/backend_images/portrait/small/avatar-s-3.png') }}" alt="Generic placeholder image">
                  </div>
                  <div class="media-body">
                    Sometimes life is going to hit you in the head with a brick. Don't lose faith.
                  </div>
