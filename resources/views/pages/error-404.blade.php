    ...
    <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
      <div class="card-content">
        <div class="card-body text-center">
          <img src="{{ asset('images/backend_images/pages/404.png') }}" class="img-fluid align-self-center" alt="branding logo">
          ...
          <a class="btn btn-primary btn-lg mt-2" href="{{ url('/admin/dashboard') }}">Back to Home</a>
        </div>
      </div>
    </div>
  </div>
