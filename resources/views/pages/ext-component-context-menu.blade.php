...
@section('mystyle')
        ...
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/plugins/extensions/context-menu.css')) }}">
@endsection
@section('content')
  <!-- context-menu Starts -->
...
@section('myscript')
        <!-- Page js files -->
        <script src="{{ asset(mix('js/backend_js/scripts/extensions/context-menu.js')) }}"></script>
@endsection
