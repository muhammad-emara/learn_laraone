...
@section('mystyle')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/plugins/calendars/fullcalendar.css')) }}">
@endsection
@section('content')
<!-- Full calendar start -->
...
@section('myscript')
        <!-- Page js files -->
        <script src="{{ asset(mix('js/backend_js/scripts/extensions/fullcalendar.js')) }}"></script>
@endsection
