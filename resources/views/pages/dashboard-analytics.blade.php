...
@section('mystyle')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/pages/dashboard-analytics.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/pages/card-analytics.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/plugins/tour/tour.css')) }}">
  @endsection
          ...
          <div class="card bg-analytics text-white">
            <div class="card-content">
              <div class="card-body text-center">
                <img src="{{ asset('images/backend_images/elements/decore-left.png') }}" class="img-left" alt="card-img-left">
                <img src="{{ asset('images/backend_images/elements/decore-right.png')}}" class="img-right" alt="card-img-right">
...
@section('myscript')
        <!-- Page js files -->
        <script src="{{ asset(mix('js/backend_js/scripts/pages/dashboard-analytics.js')) }}"></script>
@endsection
