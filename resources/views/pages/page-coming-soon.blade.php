...
@section('mystyle')
        {{-- Page Css files --}}
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/pages/coming-soon.css')) }}">
@endsection
@section('content')
        ...
        <div class="card text-center w-100 mb-0">
            ...
            <div class="card-content">
                <div class="card-body pt-0">
                    <img src="{{ asset('images/backend_images/pages/rocket.png') }}" class="img-responsive block width-150 mx-auto" width="150" alt="bg-img">
...
@section('myscript')
        {{-- Page js files --}}
        <script src="{{ asset(mix('js/backend_js/scripts/pages/coming-soon.js')) }}"></script>
@endsection
