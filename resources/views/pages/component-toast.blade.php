          ...
          <div class="card-body">
            ...
            <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-delay="5000">
              <div class="toast-header">
                <img src="{{ asset('images/backend_images/logo/logo.png') }}" class="rounded mr-2" alt="Toast image">
...
@section('myscript')
        {{-- Page js files --}}
        <script src="{{ asset(mix('js/backend_js/scripts/pages/bootstrap-toast.js')) }}"></script>
@endsection
