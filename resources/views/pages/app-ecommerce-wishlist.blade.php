...
@section('mystyle')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/pages/app-ecommerce-shop.css')) }}">
@endsection
@section('content')
  <!-- Wishlist Starts -->
<section id="wishlist" class="grid-view wishlist-items">
    <div class="card ecommerce-card">
        ...
        <div class="item-img text-center">
            <img src="{{ asset('images/backend_images/pages/eCommerce/1.png') }}" class="img-fluid" alt="img-placeholder">
        </div>
        <div class="card-body">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
        <div class="item-img text-center">
            <img src="{{ asset('images/backend_images/pages/eCommerce/2.png') }}" class="img-fluid" alt="img-placeholder">
        </div>
        <div class="card-body">
            <div class="item-wrapper">
            <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
        <div class="item-img text-center">
            <img src="{{ asset('images/backend_images/pages/eCommerce/3.png') }}" class="img-fluid" alt="img-placeholder">
        </div>
        <div class="card-body">
            <div class="item-wrapper">
            <div class="item-rating">
        ...
        <div class="item-options text-center">
            ...
            <i class="feather icon-shopping-cart"></i> <a href="app-ecommerce-checkout" class="view-in-cart">View to
                cart</a>
            </div>
        </div>
        </div>
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
        <div class="item-img text-center">
            <img src="{{ asset('images/backend_images/pages/eCommerce/4.png') }}" class="img-fluid" alt="img-placeholder">
        </div>
        <div class="card-body">
            <div class="item-wrapper">
            <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
        <div class="item-img text-center">
            <img src="{{ asset('images/backend_images/pages/eCommerce/5.png') }}" class="img-fluid" alt="img-placeholder">
        </div>
        <div class="card-body">
            <div class="item-wrapper">
            <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
        <div class="item-img text-center">
            <img src="{{ asset('images/backend_images/pages/eCommerce/6.png') }}" class="img-fluid" alt="img-placeholder">
        </div>
        <div class="card-body">
            <div class="item-wrapper">
            <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
        <div class="item-img text-center">
            <img src="{{ asset('images/backend_images/pages/eCommerce/7.png') }}" class="img-fluid" alt="img-placeholder">
        </div>
        <div class="card-body">
            <div class="item-wrapper">
            <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
        <div class="item-img text-center">
            <img src="{{ asset('images/backend_images/pages/eCommerce/8.png') }}" class="img-fluid" alt="img-placeholder">
        </div>
        <div class="card-body">
            <div class="item-wrapper">
            <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
        <div class="item-img text-center">
            <img src="{{ asset('images/backend_images/pages/eCommerce/9.png') }}" class="img-fluid" alt="img-placeholder">
        </div>
        <div class="card-body">
            <div class="item-wrapper">
            <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
        <div class="item-img text-center">
            <img src="{{ asset('images/backend_images/pages/eCommerce/10.png') }}" class="img-fluid" alt="img-placeholder">
        </div>
        <div class="card-body">
            <div class="item-wrapper">
            <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
        <div class="item-img text-center">
            <img src="{{ asset('images/backend_images/pages/eCommerce/11.png') }}" class="img-fluid" alt="img-placeholder">
        </div>
        <div class="card-body">
            <div class="item-wrapper">
            <div class="item-rating">
...
@section('myscript')
    <!-- Page js files -->
    <script src="{{ asset(mix('js/backend_js/scripts/pages/app-ecommerce-shop.js')) }}"></script>
@endsection
