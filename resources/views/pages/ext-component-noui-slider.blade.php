...
@section('mystyle')
        ...
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/core/colors/palette-noui.css')) }}">
@endsection
@section('content')
...
@section('myscript')
        <!-- Page js files -->
        <script src="{{ asset(mix('js/backend_js/scripts/extensions/noui-slider.js')) }}"></script>
@endsection
