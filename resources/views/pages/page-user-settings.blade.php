...
@section('mystyle')
        {{-- Page Css files --}}
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/pages/user-settings.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/plugins/file-uploaders/dropzone.css')) }}">
@endsection
@section('content')
<!--Settings-begins -->
<section>
            ...
            <div class="lead collapse-title" data-toggle="collapse" role="button" data-target="#collapse1"
              ...
              <div class="media">
                <a class="media-left" href="#">
                  <img  class="rounded-circle mr-2" src="{{ asset('images/backend_images/portrait/small/avatar-s-3.png') }}" alt="Generic placeholder image"
                    height="64" width="64" />
                </a>
...
@section('myscript')
{{-- Page js files --}}
        <script src="{{ asset(mix('js/backend_js/scripts/extensions/dropzone.js')) }}"></script>
        <script src="{{ asset(mix('js/backend_js/scripts/pages/user-settings.js')) }}"></script>
@endsection
