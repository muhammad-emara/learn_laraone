...
@section('mystyle')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset(mix('css/backend_css/plugins/extensions/drag-and-drop.css')) }}">
@endsection
@section('content')
          ...
          <div class="card-body">
            ...
            <ul class="list-group" id="basic-list-group">
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('images/backend_images/portrait/small/avatar-s-12.png') }}" class="rounded-circle mr-2"
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('images/backend_images/portrait/small/avatar-s-1.png') }}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('images/backend_images/portrait/small/avatar-s-2.png') }}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('images/backend_images/portrait/small/avatar-s-3.png') }}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('images/backend_images/portrait/small/avatar-s-4.png') }}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
...
@section('myscript')
        <!-- Page js files -->
        <script src="{{ asset(mix('js/backend_js/scripts/extensions/drag-drop.js')) }}"></script>
@endsection
